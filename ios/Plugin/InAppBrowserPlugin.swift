...
public class InAppBrowserPlugin: CAPPlugin, CAPBridgedPlugin {
    ...
    func presentView(isAnimated: Bool = true) {
        ...
        if let webViewController = self.webViewController {
            ...
            let bottomInset = (self.bridge?.viewController?.view.safeAreaInsets.bottom ?? 0) + 35
    ...
    @objc func openWebView(_ call: CAPPluginCall) {
        ...
        DispatchQueue.main.async {
            ...
            // We're using pageSheet presentation style in presentView method
    ...
    @objc func open(_ call: CAPPluginCall) {
        ...
        DispatchQueue.main.async {
            ...
            self.webViewController = WKWebViewController.init(
                url: url, headers: headers, isInspectable: isInspectable, credentials: credentials,
                preventDeeplink: preventDeeplink, blankNavigationTab: true)
